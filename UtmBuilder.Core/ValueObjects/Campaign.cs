...
namespace UtmBuilder.Core.ValueObjects
{
  public class Campaign : ValueObject
  {
    ...
    /// <summary>
    /// Product, promo code, or slogan (e.g. spring_sale, black_friday)
    /// </summary>
    ...
    public Campaign(string source, string medium, string name, string? id = null, string? term = null, string? content = null)
    {
      ...
      InvalidCampaignException.ThrowIfNull(source, "Source cannot be null");
      InvalidCampaignException.ThrowIfNull(medium, "Medium cannot be null");
      InvalidCampaignException.ThrowIfNull(name, "Name cannot be null");
    }
  }
}